...
public class Quiz {
    ...
    답: 3
    풀이: ArrayList에서 객체를 삭제하면 삭제된 뒤에 있는 객체들이 한칸씩 앞으로 당겨진다.
    ...
    3. Set 컬렉션에 대한 설명 중 틀린 것은 무엇입니까?
     ...
     답: 4
     풀이: Set 컬렉션에도 null을 저장할수있다. 단, 하나의 null만 저장이 가능하다.


    4. Map 컬렉션에 대한 설명 중 틀린 것은 무엇입니까?.
     ➊ 대표적인 구현 클래스로는 HashMap, Hashtable, TreeMap, Properties가 있다. O
     ...
     답: 3
     풀이: 멀테 스레드 환경에서는 HashMap 보다는 Hashtable이 스레드에 안전하다(Thread-safe)
     */
}
